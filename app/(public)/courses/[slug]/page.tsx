                                            ...
                                            <div className="bg-muted/20 border-t">
                                                <div className="space-y-3 p-6 pt-4">
                                                    {chapter.lessons.map((lesson, lessonIndex) => (
                                                        ...
                                                        >
                                                            <div className="bg-background border-primary/20 hover:border-primary flex size-8 items-center justify-center rounded-full border-2">
                    ...
                    <div className="sticky top-20">
                        <Card className="py-0">
                            <CardContent className="p-6">
                                ...
                                <div className="bg-primary/15 mb-6 space-y-3 rounded-lg p-6">
