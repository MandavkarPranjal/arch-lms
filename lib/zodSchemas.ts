...
export const courseSchema = z.object({
    ...
    description: z.string().min(3, { message: 'Description must be at least 3 character long' }),

    filekey: z.string().min(1, { message: 'File is required' }),

    price: z.coerce.number().min(1, { message: 'Price must be a positive number' }), // user can't create free courses
